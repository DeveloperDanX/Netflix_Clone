...
import {View,Text, StyleSheet, TouchableWithoutFeedback, ImageBackground, FlatList} from 'react-native'
...
export default class Episodes extends Component{
    ...
    renderEpisodes(item){
        //const episodes = items.details.episodes
    ...
    render(){
        ...
        //const {episodes} = shows_first
        //const {episodes} = this.props.route.params
